export default {
    ...
    max_value: (field, max_value) => `O valor máximo permitido no campo ${field} é ${max_value}.`,
    min_value: (field, min_value) => `O valor mínimo permitido no campo ${field} é ${min_value}.`
};
